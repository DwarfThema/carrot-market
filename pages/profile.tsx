    ...
    <div className="py-10 px-4">
      <div className="flex items-center space-x-3">
        ...
        <div className="flex flex-col">
          <span className="font-medium text-gray-900 ">호챠챠</span>
          <span className="text-sm text-gray-700">프로필 수정 &rarr;</span>
        </div>
      </div>
      <div className="mt-10 flex justify-around">
        <div className="flex flex-col items-center">
          <div className="w-14 h-14 text-white bg-purple-600 rounded-full flex items-center justify-center">
            <svg
              className="w-6 h-6"
              fill="none"
              stroke="currentColor"
      ...
      <div className="mt-12">
        <div className="flex itmes-center space-x-4 items-center">
          <div className="w-12 h-12 rounded-full bg-gray-500" />
          <div>
            <h4 className="text-sm font-bold text-gray-900">준호</h4>
